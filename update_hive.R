...
# print("完成执行ltv.sql")
print("开始执行ads_l1_eda_multidimensional_indicators_df.sql")
run_hive_query("sql/ads_l1_eda_multidimensional_indicators_df.sql", "ads_l1_eda_multidimensional_indicators_df")
print("完成执行ads_l1_eda_multidimensional_indicators_df.sql")
